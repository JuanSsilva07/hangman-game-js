...
function updateHangmanPicture() {
  document.getElementById('hangmanPic').src = './assets/image/' + mistakes + '.png';
}
...
function reset() {
  mistakes = 0;
  guessed = [];
  document.getElementById('hangmanPic').src = './assets/image/0.png';
...
function addWord(){
  const newWord = document.getElementById('addNewWord').value;
  programming_languages.push(newWord);
